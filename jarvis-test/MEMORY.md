...
- **2026-06-02** — Установлена архитектура Агента из шаблона `Ntmib/jarvis-architect`. 6 скиллов в `.claude/skills/`, плагин Superpowers подключён. Первый коммит запушен на GitHub.
